...
let testFullDate
let testFullSec = 0
const isLessThen = function _isLessThen (year, month, date, minDate) {
...
const isLargerThen = function _isLargerThen (year, month, date, maxDate) {
  ...
  for (let i=0; i<length; i++) {
    arr.push({
      ...
      selected: valueDate &&
                ...
                i + 1 === valueDate.date,
      day: i + 1,
      disabled: isLessThen(year, month, i + 1, minDate) ||
                  isLargerThen(year, month, i + 1, maxDate),
